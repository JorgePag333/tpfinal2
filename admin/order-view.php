                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <td class="text-center">
                                ...
                                ?>
                                <a href="./report/Facturas.php?id=<?php echo $order['NIT'];  ?>&np=<?php echo $order['NumPedido']?>" class="btn btn-raised btn-xs btn-primary btn-block" target="_blank">Imprimir Remito</a>
                            </td>
                            <td class="text-center">
...
<script>//funcion javascript para ACTUALIZAR EL ESTADO DEL PEDIDO
